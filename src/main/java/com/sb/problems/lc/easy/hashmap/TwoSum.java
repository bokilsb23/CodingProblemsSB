 ...
 */
public class TwoSum {
    // This fails if a number is present in the array twice
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(ts.twoSum(new int[]{3, 2, 4, 6}, 6)));
        ...
        System.out.println(Arrays.toString(ts.twoSum2(new int[]{3, 2, 4, 6}, 6)));
        System.out.println(Arrays.toString(ts.twoSum2(new int[]{3, 3}, 6)));
    }
}
